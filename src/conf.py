...
project = 'Open SoC Debug'
copyright = '2016-%d, The Open SoC Debug Contributors' % datetime.now().year
author = 'The Open SoC Debug Contributors'
...
if not read_the_docs_build:
    latex_documents += [
        ('01_overview/index', 'osd-overview.tex', 'Open SoC Debug Overview',
         'The Open SoC Debug Contributors', 'manual'),

        ('02_spec/index', 'osd-spec.tex', 'Open SoC Debug Specification',
         'The Open SoC Debug Contributors', 'manual'),

        ('03_user/index', 'osd-userguide.tex', 'Open SoC Debug User Guides',
         'The Open SoC Debug Contributors', 'manual'),

        ('04_implementer/index', 'osd-implementerguide.tex',
         'Open SoC Debug Implementer Guides',
         'The Open SoC Debug Contributors', 'manual'),
    ]
...
man_pages = [
    (master_doc, 'opensocdebug', 'Open SoC Debug Documentation',
     [author], 1)
]
